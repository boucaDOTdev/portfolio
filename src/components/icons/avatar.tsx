        ...
        <g transform='translate(825.000000, 1100.000000)'>
          ...
          >
            ...
            <g id='Clothing/Hoodie' transform='translate(0.000000, 170.000000)'>
              ...
              <mask id='react-mask-874' fill='white'>
                <use xlink:href='#react-path-873'></use>
              </mask>
              <use
                id='Hoodie'
                fill='#B7C1DB'
                fill-rule='evenodd'
                xlink:href='#react-path-873'
              ></use>
              <g
                id='Color/Palette/Gray-01'
                mask='url(#react-mask-874)'
                fill-rule='evenodd'
                fill='#5199E4'
              >
            ...
            >
              <g id='Mouth/Smile' transform='translate(2.000000, 52.000000)'>
                ...
                <mask id='react-mask-834' fill='white'>
                  <use xlink:href='#react-path-833'></use>
                </mask>
                <use
                  id='Mouth'
                  ...
                  fill='#000000'
                  fill-rule='evenodd'
                  xlink:href='#react-path-833'
                ></use>
                <rect
                  id='Teeth'
                  fill='#FFFFFF'
                  fill-rule='evenodd'
                  mask='url(#react-mask-834)'
                  x='39'
                  y='2'
                  width='31'
                  height='16'
            ...
            <g id='Top' stroke-width='1' fill-rule='evenodd'>
              ...
              <mask id='react-mask-929' fill='white'>
                <use xlink:href='#react-path-931'></use>
              </mask>
              <g id='Mask'></g>
              <g id='Top/Short-Hair/Short-Waved' mask='url(#react-mask-929)'>
                <g transform='translate(-1.000000, 0.000000)'>
                  <mask id='react-mask-928' fill='white'>
                    <use xlink:href='#react-path-930'></use>
                  </mask>
                  <use
                    id='Short-Hair'
                    stroke='none'
                    fill='#28354B'
                    fill-rule='evenodd'
                    xlink:href='#react-path-930'
                  ></use>
                  <g
                    id='Skin/👶🏽-03-Brown'
                    mask='url(#react-mask-928)'
                    fill='#4A312C'
                  >
                    <g transform='translate(0.000000, 0.000000) ' id='Color'>
                      <rect x='0' y='0' width='264' height='280'></rect>
